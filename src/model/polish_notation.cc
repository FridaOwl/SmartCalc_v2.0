...
void PolishNotation::findNumeric(const std::string &infix, size_t &index, std::string &postfix) {
...
void PolishNotation::handleClosingParenthesis(std::stack<char> &operatorStack, std::string &postfix) {
...
void PolishNotation::handleOperator(char c, std::stack<char> &operatorStack, std::string &postfix) {
    while (!operatorStack.empty() && operatorStack.top() != '(' &&
           (c != '^' ? priorityOperation(operatorStack.top()) >= priorityOperation(c)
...
void PolishNotation::handleFunction(const std::string &infix, size_t &index, std::stack<char> &operatorStack) {
    std::string fx = "";
